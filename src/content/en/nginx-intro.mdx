...
The repo with the code used in this article is available [here](https://github.com/Viilih/nginx-resources/tree/main/01-static-server) and the next articles will be added to the same repo, so feel free to check it out!
